...
create user victor_luis with createdb createrole inherit replication bypassrls password '123';
create database uvv owner template = template0 encoding = 'UTF8' lc_collate = 'pt_BR.UTF-8' lc_ctype = 'pt_BR.UTF-8';

/* CRIAÇÃO DO ESQUEMA */

create schema hr;
alter schema hr owner to victor_luis;

/* MUDAR PARA O ESQUEMA HR */
...
COMMENT ON TABLE hr.cargos IS 'Tabela de cargos dos empregados';
COMMENT ON COLUMN hr.cargos.id_cargo IS 'Chave primária da tabela';
COMMENT ON COLUMN hr.cargos.cargo IS 'Nome do cargo que funciona como chave alternativa';
COMMENT ON COLUMN hr.cargos.salario_minimo IS 'Salário mínimo possível para o cargo';
COMMENT ON COLUMN hr.cargos.salario_maximo IS 'Salário máximo possível para um cargo';
...
COMMENT ON TABLE hr.regioes IS 'Tabela referente as regioes';
COMMENT ON COLUMN hr.regioes.id_regiao IS 'Chave primária da tabela';
COMMENT ON COLUMN hr.regioes.nome IS 'Nome das regioes';
...
COMMENT ON TABLE hr.paises IS 'Tabela referente aos países';
COMMENT ON COLUMN hr.paises.id_paises IS 'Chave primária da tabela';
COMMENT ON COLUMN hr.paises.nome IS 'Nome dos países que funciona como chave alternativa';
COMMENT ON COLUMN hr.paises.id_regiao IS 'Chave estrangeira referente as regiões';
...
/* CIRAÇÃO DA TABELA LOCALIZAÇÕES */
...
/* CRIAÇÃO DOS COMENTARIOS DA TABELA */

COMMENT ON TABLE hr.localizacoes IS 'Tabela referente a localizações';
COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'Chave primária da tabela';
COMMENT ON COLUMN hr.localizacoes.endereco IS 'Endereço da localização';
...
COMMENT ON COLUMN hr.localizacoes.id_paises IS 'Chave estrangeira referente aos países';
...
COMMENT ON TABLE hr.departamentos IS 'Tabela referente aos departamentos';
COMMENT ON COLUMN hr.departamentos.id_departamento IS 'Chave primária da tabela';
COMMENT ON COLUMN hr.departamentos.nome IS 'Nome dos departamentos que funcionam como chave alternativa';
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'Chave estrangeira da tabela referente a localização';
COMMENT ON COLUMN hr.departamentos.id_gerente IS 'Chave estrangeira referente ao gerente';
...
COMMENT ON TABLE hr.empregados IS 'Tabela referente aos empregados da empresa';
...
COMMENT ON COLUMN hr.empregados.email IS 'Email do empregado que funciona como chave alternativa';
COMMENT ON COLUMN hr.empregados.data_contratacao IS 'Data de contratação do empregado';
COMMENT ON COLUMN hr.empregados.salario IS 'Salário recebido pelo empregado';
COMMENT ON COLUMN hr.empregados.comissao IS 'Comissao recebida pelo empregado';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'Chave estrangeira relacionada ao departamento';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'Supervisor relacionado ao empregado';
COMMENT ON COLUMN hr.empregados.id_cargo IS 'Chave estrangeira relacionada ao cargo do empregado';
...
COMMENT ON TABLE hr.historico_cargos IS 'Tabela referente ao histórico de cargos do empregado';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'Chave primária e estrangeira da tabela relacionado ao empregado';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'Data inicial do empregado no cargo e parte da chave primária composta da tabela';
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'Chave estrangeira relacionada ao cargo';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'Chave estrangeira da tabela relacionado ao departamento';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'Data final do empregado no cargo';
