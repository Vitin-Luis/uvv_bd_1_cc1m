...
create database uvv;
create user 'victor_luis' @localhost identified by '123';
grant all privileges on *.* to 'victor_luis'@localhost identified by '123';
...
ALTER TABLE cargos COMMENT 'Tabela de cargos dos empregados';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave primária da tabela';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Nome do cargo que funciona como chave alternativa';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'Salário mínimo possível para o cargo';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'Salário máximo possível para um cargo';

/* CRIAÇÃO DA CHAVE ALTERNATIVA DA TABELA */

CREATE UNIQUE INDEX nome_cargo
 ON cargos
 ( cargo );
...
ALTER TABLE regioes COMMENT 'Tabela referente as regioes';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Chave primária da tabela';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Nome das regioes';

/* CRIAÇÃO DA CHAVE ALTERNATIVA DA TABELA */

CREATE UNIQUE INDEX nome_regioes
 ON regioes
 ( nome );
...
ALTER TABLE paises COMMENT 'Tabela referente aos países';

ALTER TABLE paises MODIFY COLUMN id_paises CHAR(2) COMMENT 'Chave primária da tabela';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome dos países que funciona como chave alternativa';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'Chave estrangeira referente as regiões';

/* CRIAÇÃO DA CHAVE ALTERNATIVA DA TABELA */

CREATE UNIQUE INDEX nome_paises
 ON paises
 ( nome );
...
ALTER TABLE localizacoes COMMENT 'Tabela referente a localizações';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Chave primária da tabela';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Endereço da localização';
...
ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado da localização';

ALTER TABLE localizacoes MODIFY COLUMN id_paises CHAR(2) COMMENT 'Chave estrangeira referente aos países';
...
ALTER TABLE departamentos COMMENT 'Tabela referente aos departamentos';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave primária da tabela';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome dos departamentos que funcionam como chave alternativa';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'Chave estrangeira da tabela referente a localização';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'Chave estrangeira referente ao gerente';
...
ALTER TABLE empregados COMMENT 'Tabela referente aos empregados da empresa';
...
ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'Email do empregado que funciona como chave alternativa';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data de contratação do empregado';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Salário recebido pelo empregado';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Comissao recebida pelo empregado';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira relacionada ao departamento';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'Supervisor relacionado ao empregado';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave estrangeira relacionada ao cargo do empregado';

/* CRIAÇÃO DA CHAVE ALTERNATIVA */
...
ALTER TABLE historico_cargos COMMENT 'Tabela referente ao histórico de cargos do empregado';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'Chave primária e estrangeira da tabela relacionado ao empregado';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Data inicial do empregado no cargo e parte da chave primária composta da tabela';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Chave estrangeira relacionada ao cargo';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave estrangeira da tabela relacionado ao departamento';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'Data final do empregado no cargo';

/* CRIAÇÃO DA FOREIGN KEY DA TABELA EMPREGADOS */
...
/* CRIAÇÃO DA FOREIGN KEY DA TABELA HISTORICO_CARGOS */
...
/* CRIAÇÃO DA FOREIGN KEY DA TABELA PAISES */
...
/* CRIAÇÃO DA FOREIGN KEY DA TABELA LOCALIZACOES */
...
/* CRIAÇÃO DA FOREIGN KEY DA TABELA DEPARTAMENTOS */
...
/* INSERÇÃO DE DADOS DA TABELA PAISES */

INSERT INTO paises (id_paises, nome, id_regiao) VALUES
('AR', 'Argentina', 2);
INSERT INTO paises (id_paises, nome, id_regiao) VALUES
('AU', 'Australia', 3);
INSERT INTO paises (id_paises, nome, id_regiao) VALUES
...
/* INSERÇÃO DE DADOS DA TABELA LOCALIZACOES */

INSERT INTO localizacoes (id_localizacao, endereco, cep, cidade, uf, id_paises) VALUES
...
/* INSERÇÃO DE DADOS DA TABELA DEPARTAMENTOS */
...
/* INSERÇÃO DE DADOS DA TABELA EMPREGADOS */
...
/* INSERÇÃO DE DADOS DA TABELA HISTORICO_CARGOS */
...
/* UPDATE NOS VALORES DO GERENTE  */

update departamentos set id_gerente = 200 where id_departamento = 10;

update departamentos set id_gerente = 202 where id_departamento = 20;
